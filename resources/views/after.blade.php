...
<div id="main" class="cover blur-in">
	<section class="post" id="jump-action">
		<div>
			<p class="pic_left_right">
				<span class="image left"><img src="images/Logo_After_600x600px.png" alt="" /></span>
			...
			<p style="font-size: 200%;" class="pic_left_right"><span class="image right"><img src="images/Vorlag-600x600px-Karte.png" alt=""/></span>
				...
				und Weitersagen uns geholfen haben, zu helfen.
				Danke an alle Gastronomen für's teilnehmen.
				Wir wünschen Euch viel Glück.
				Die Verlosung findet am kommenden Montag,
				den 8. Juni ab 17 Uhr auf unseren Social Media
				Kanälen (Facebook und Instagram) statt.
			</p>
